...
## Notes / v1 scope
Offline support, per-user reminder times, streaks, group-chat leaderboard embedding, admin export, and animations beyond the progress bar are intentionally out of scope (see the spec).
